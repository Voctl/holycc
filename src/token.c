...
#define T(k, n, s) [k] = {n, s}
    ...
    T(TOK_KW_HAS,             "has",                  "has"),
    T(TOK_KW_REG,             "reg",                  "reg"),
    T(TOK_KW_NOREG,           "noreg",                "noreg"),
    T(TOK_KW_TRY,             "try",                  "try"),
    T(TOK_KW_CATCH,           "catch",                "catch"),
    T(TOK_KW_THROW,           "throw",                "throw"),
    T(TOK_PP_IF,              "#if",                  "#if"),
    T(TOK_PP_ELSE,            "#else",                "#else"),
    T(TOK_PP_ENDIF,           "#endif",               "#endif"),
    T(TOK_PP_IFDEF,           "#ifdef",               "#ifdef"),
    T(TOK_PP_IFNDEF,          "#ifndef",              "#ifndef"),
    T(TOK_PP_ELIF,            "#elif",                "#elif"),
#undef T
};
